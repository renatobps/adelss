<!doctype html><html class="fixed">
	<head>
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Basic Forms | Porto Admin - Responsive HTML5 Template</title>
							...
							<div class="col">
								<section class="card">
									...
									<div class="card-body">
										<form class="form-horizontal form-bordered" method="get">
											<div class="form-group row pb-4">
												<label class="col-lg-3 control-label text-lg-end pt-2">Input sizing</label>
												<div class="col-lg-6">
											...
											<div class="form-group row pb-4">
												<label class="col-lg-3 control-label text-lg-end pt-2">Select sizing</label>
												<div class="col-lg-6">
							...
							<div class="col">
								<section class="card">
									...
									<div class="card-body">
										<form class="form-horizontal form-bordered" method="get">
											<div class="form-group row pb-4">
												<label class="col-lg-3 control-label text-lg-end pt-2">Basic examples</label>
												<div class="col-lg-6">
											...
											<div class="form-group row pb-4">
												<label class="col-lg-3 control-label text-lg-end pt-2">Sizing</label>
												<div class="col-lg-6">
											...
											<div class="form-group row pb-4">
												<label class="col-lg-3 control-label text-lg-end pt-2">Iconic</label>
												<div class="col-lg-6">
													<div class="input-group mb-3">
														<span class="input-group-text">
															<i class="fas fa-user"></i>
											...
											<div class="form-group row pb-4">
												<label class="col-lg-3 control-label text-lg-end pt-2">Checkbox and radio</label>
												<div class="col-lg-6">
													<div class="input-group mb-3">
														<span class="input-group-text">
															<input type="checkbox">
											...
											<div class="form-group row pb-4">
												<label class="col-lg-3 control-label text-lg-end pt-2">Button addons</label>
												<div class="col-lg-6">
													<div class="input-group mb-3">
											...
											<div class="form-group row pb-4">
												<label class="col-lg-3 control-label text-lg-end pt-2">Segmented buttons</label>
												<div class="col-lg-6">
													<div class="input-group mb-3">
														<div class="btn-group">
													...
													<div class="input-group mb-3">
														...
														<div class="btn-group">
															...
															<div class="btn-group" role="group">
																<button tabindex="-1" data-bs-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button">
								...
								<section class="card">
									...
									<div class="card-body">
										<form class="form-horizontal form-bordered" method="get">
											...
											<div class="form-group row pb-4">
												<label class="col-lg-3 control-label text-lg-end pt-2" for="textareaAutosize">Textarea autosize</label>
												<div class="col-lg-6">
