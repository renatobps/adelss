...
class FinancialRouteAuthorizer
{
    ...
    private function authorizeCampaignRoute(User $user, ?string $routeName, callable $denyAccess): ?Response
    {
        $action = match ($routeName) {
            ...
            'financial.campaigns.sponsors.update',
            'financial.campaigns.reminders.global.update',
            'financial.campaigns.reminders.update',
            'financial.campaigns.reminders.toggle-sponsor' => 'edit',
            ...
            'financial.campaigns.sponsors.charge-overdue',
            'financial.campaigns.reminders.send-now',
            'financial.campaigns.reminders.test' => 'pagar',
