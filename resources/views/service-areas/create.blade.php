...
@section('title', 'Nova Área de Serviço')

@section('page-title', 'Nova Área de Serviço')
    ...
    <div class="col-12">
        <section class="card">
            <header class="card-header">
                ...
                <h2 class="card-title">
                    <i class="bx bx-category me-2"></i>Nova Área de Serviço
                </h2>
            </header>
            <div class="card-body">
                <form action="{{ route('voluntarios.areas.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Descreva a área de serviço...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="form-select @error('allowed_audience') is-invalid @enderror" 
                                ...
                                <option value="ambos" {{ old('allowed_audience', 'ambos') == 'ambos' ? 'selected' : '' }}>Ambos</option>
                                <option value="adulto" {{ old('allowed_audience') == 'adulto' ? 'selected' : '' }}>Adulto</option>
                                <option value="jovem" {{ old('allowed_audience') == 'jovem' ? 'selected' : '' }}>Jovem</option>
                            </select>
