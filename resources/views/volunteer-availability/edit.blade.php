...
@section('page-title', 'Editar Disponibilidade')
    ...
    <div class="col-12">
        <section class="card">
            <header class="card-header">
                ...
                <h2 class="card-title">
                    <i class="bx bx-edit me-2"></i>Editar Disponibilidade - {{ $disponibilidade->volunteer->member->name }}
                </h2>
            </header>
            <div class="card-body">
                <form action="{{ route('voluntarios.disponibilidade.update', $disponibilidade) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="row">
                                @php
                                    ...
                                    $selectedDays = old('days_of_week', $disponibilidade->days_of_week ?? []);
                                @endphp
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" class="form-control @error('time_start') is-invalid @enderror" 
                                   id="time_start" name="time_start" value="{{ old('time_start', $disponibilidade->time_start ? \Carbon\Carbon::parse($disponibilidade->time_start)->format('H:i') : '') }}">
                            @error('time_start')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" class="form-control @error('time_end') is-invalid @enderror" 
                                   id="time_end" name="time_end" value="{{ old('time_end', $disponibilidade->time_end ? \Carbon\Carbon::parse($disponibilidade->time_end)->format('H:i') : '') }}">
                            @error('time_end')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('unavailable_start') is-invalid @enderror" 
                                   id="unavailable_start" name="unavailable_start" value="{{ old('unavailable_start', $disponibilidade->unavailable_start ? $disponibilidade->unavailable_start->format('Y-m-d') : '') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('unavailable_end') is-invalid @enderror" 
                                   id="unavailable_end" name="unavailable_end" value="{{ old('unavailable_end', $disponibilidade->unavailable_end ? $disponibilidade->unavailable_end->format('Y-m-d') : '') }}">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select class="form-select @error('events') is-invalid @enderror" 
                                ...
                                @php
                                    $selectedEvents = old('events', $disponibilidade->volunteer->availabilityEvents->pluck('id')->toArray());
                                @endphp
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      ...
                                      placeholder="Informações adicionais sobre a disponibilidade...">{{ old('notes', $disponibilidade->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
