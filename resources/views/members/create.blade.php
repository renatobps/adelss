...
@section('page-title', 'Novo Membro')
    ...
    <div class="col-12">
        <section class="card">
            <header class="card-header">
                ...
                <h2 class="card-title">
                    <i class="bx bx-user-plus me-2"></i>Novo Membro
                </h2>
                <p class="card-subtitle">Cadastre um novo membro no sistema</p>
            </header>
            <div class="card-body">
                <form action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="membro_transferido" {{ old('status') == 'membro_transferido' ? 'selected' : '' }}>Membro Transferido</option>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('membership_date') is-invalid @enderror" 
                                       id="membership_date" name="membership_date" value="{{ old('membership_date') }}">
                        ...
                        @include('members.partials.custom-fields', ['customFields' => $customFields ?? collect()])
