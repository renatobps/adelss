...
@section('title', 'Criar Indicador')

@section('page-title', 'Criar Indicador')
...
<div class="row">
    <div class="col-lg-8">
        <div class="card" style="border: none; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <div class="card-body">
                <form action="{{ route('discipleship.indicators.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bx bx-check me-1"></i>Criar Indicador
                        </button>
                    </div>
                </form>
            </div>
