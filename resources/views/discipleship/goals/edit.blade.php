...
@section('title', 'Editar Propósito')

@section('page-title', 'Editar Propósito')
...
@php
    ...
    $restricoesOld = old('restricoes', is_array($goal->restricoes) ? $goal->restricoes : []);
    $alimentosOld = old('alimentos_retirados', is_array($goal->alimentos_retirados) ? $goal->alimentos_retirados : []);
@endphp
...
<div class="row">
    <div class="col-lg-12">
        <div class="card" style="border: none; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <div class="card-body">
                <form action="{{ route('discipleship.goals.update', $goal) }}" method="POST" id="goalForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('discipleship_member_id') is-invalid @enderror" id="discipleship_member_id" name="discipleship_member_id" required>
                                    ...
                                    @foreach($members as $m)
                                        <option value="{{ $m->id }}" {{ old('discipleship_member_id', $goal->discipleship_member_id) == $m->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('tipo') is-invalid @enderror" id="tipo" name="tipo" required>
                                    <option value="espiritual" {{ old('tipo', $goal->tipo) === 'espiritual' ? 'selected' : '' }}>Espiritual</option>
                                    <option value="material" {{ old('tipo', $goal->tipo) === 'material' ? 'selected' : '' }}>Material</option>
                                </select>
                                @error('tipo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('descricao') is-invalid @enderror" 
                                   id="descricao" name="descricao" value="{{ old('descricao', $goal->descricao) }}" required>
                            @error('descricao')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('prazo') is-invalid @enderror" 
                                       id="prazo" name="prazo" value="{{ old('prazo', $goal->prazo ? $goal->prazo->format('Y-m-d') : '') }}">
                                @error('prazo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                    <option value="em_andamento" {{ old('status', $goal->status) === 'em_andamento' ? 'selected' : '' }}>Em Andamento</option>
                                    <option value="concluido" {{ old('status', $goal->status) === 'concluido' ? 'selected' : '' }}>Concluído</option>
                                    <option value="pausado" {{ old('status', $goal->status) === 'pausado' ? 'selected' : '' }}>Pausado</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('quantidade_dias') is-invalid @enderror" 
                                       ...
                                       value="{{ old('quantidade_dias', $goal->quantidade_dias) }}" min="1" max="30">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="restricoes[]" value="filmes" id="restricao_filmes" {{ in_array('filmes', $restricoesOld) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="restricao_filmes">Filmes</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="restricoes[]" value="series" id="restricao_series" {{ in_array('series', $restricoesOld) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="restricao_series">Séries</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="restricoes[]" value="instagram" id="restricao_instagram" {{ in_array('instagram', $restricoesOld) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="restricao_instagram">Instagram</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="restricoes[]" value="youtube" id="restricao_youtube" {{ in_array('youtube', $restricoesOld) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="restricao_youtube">YouTube</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="restricoes[]" value="tiktok" id="restricao_tiktok" {{ in_array('tiktok', $restricoesOld) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="restricao_tiktok">TikTok</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="restricoes[]" value="facebook" id="restricao_facebook" {{ in_array('facebook', $restricoesOld) ? 'checked' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipo_jejum" id="jejum_nenhum" value="nenhum" {{ old('tipo_jejum', $goal->tipo_jejum ?? 'nenhum') === 'nenhum' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="jejum_nenhum">Nenhum</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipo_jejum" id="jejum_total" value="total" {{ old('tipo_jejum', $goal->tipo_jejum) === 'total' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="jejum_total">Jejum Total</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipo_jejum" id="jejum_parcial" value="parcial" {{ old('tipo_jejum', $goal->tipo_jejum) === 'parcial' ? 'checked' : '' }}>
                        ...
                        <div id="jejum_total_fields" style="display: none;">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('horas_jejum_total') is-invalid @enderror" id="horas_jejum_total" name="horas_jejum_total">
                                    ...
                                    @for($i = 6; $i <= 72; $i += 6)
                                        <option value="{{ $i }}" {{ old('horas_jejum_total', $goal->horas_jejum_total) == $i ? 'selected' : '' }}>{{ $i }} horas</option>
                                    @endfor
                                </select>
                        ...
                        <div id="jejum_parcial_fields" style="display: none;">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('dias_jejum_parcial') is-invalid @enderror" 
                                           ...
                                           value="{{ old('dias_jejum_parcial', $goal->dias_jejum_parcial) }}" min="1" max="30">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="alimentos_retirados[]" value="derivados_trigo" id="alimento_trigo" {{ in_array('derivados_trigo', $alimentosOld) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="alimento_trigo">Derivados de trigo</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="alimentos_retirados[]" value="guloseimas" id="alimento_guloseimas" {{ in_array('guloseimas', $alimentosOld) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="alimento_guloseimas">Guloseimas</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="alimentos_retirados[]" value="almoco" id="alimento_almoco" {{ in_array('almoco', $alimentosOld) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="alimento_almoco">Almoço</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="alimentos_retirados[]" value="jantar" id="alimento_jantar" {{ in_array('jantar', $alimentosOld) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="alimento_jantar">Jantar</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="alimentos_retirados[]" value="cafe_manha" id="alimento_cafe" {{ in_array('cafe_manha', $alimentosOld) ? 'checked' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="periodos_oracao_dia" id="oracao_1" value="1" {{ old('periodos_oracao_dia', $goal->periodos_oracao_dia) == '1' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="oracao_1">1 vez ao dia</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="periodos_oracao_dia" id="oracao_2" value="2" {{ old('periodos_oracao_dia', $goal->periodos_oracao_dia) == '2' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="oracao_2">2 vezes ao dia</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="periodos_oracao_dia" id="oracao_3" value="3" {{ old('periodos_oracao_dia', $goal->periodos_oracao_dia) == '3' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('minutos_oracao_periodo') is-invalid @enderror" 
                                       ...
                                       value="{{ old('minutos_oracao_periodo', $goal->minutos_oracao_periodo) }}" min="1">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('livro_biblia') is-invalid @enderror" id="livro_biblia" name="livro_biblia">
                                    ...
                                    @foreach($livrosBiblia as $livro)
                                        <option value="{{ $livro }}" {{ old('livro_biblia', $goal->livro_biblia) == $livro ? 'selected' : '' }}>{{ $livro }}</option>
                                    @endforeach
                                </select>
                                @error('livro_biblia')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('capitulos_por_dia') is-invalid @enderror" 
                                       ...
                                       value="{{ old('capitulos_por_dia', $goal->capitulos_por_dia) }}" min="1">
                    ...
                    <div class="mb-4">
                        ...
                        <x-rich-text-editor
                            name="observacao"
                            id="observacao"
                            :value="old('observacao', $goal->observacao)"
