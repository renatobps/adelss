...
<div class="row">
    ...
    <div class="col-lg-9">
        ...
        <div class="card mb-4" style="border: none; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <div class="card-body">
                <form method="GET" action="{{ route('financial.reports.revenues.daily-extract') }}" id="filterForm">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h6 class="mb-0">Relatório: Receitas - Extrato diário</h6>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        <form method="GET" action="{{ route('financial.reports.revenues.daily-extract') }}" id="tableForm" style="display: contents;">
