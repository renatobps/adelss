...
<div class="row fr-page">
    ...
    <div class="col-12 col-lg-9 fr-main">
        ...
        <div class="card fr-card mb-4">
            <div class="card-body">
                ...
                <p class="text-muted mb-0">
                    As imagens entram nos PDFs (extrato, dízimos/ofertas, fechamento semanal e fechamento de caixa).
                    Os nomes vêm do cargo no cadastro de membros. Fundo transparente (PNG) funciona melhor.
                </p>
            </div>
        </div>
        ...
        <div class="card fr-card mb-4">
            <div class="card-body">
                <h6 class="mb-1">Pastor Dirigente</h6>
                <p class="small text-muted">{{ $pastorNome ?: 'Nenhum membro com cargo de pastor encontrado.' }}</p>

                @if($pastorAssinaturaSrc)
                    <div class="border rounded p-3 mb-3 text-center bg-light">
                        <img src="{{ $pastorAssinaturaSrc }}" alt="Assinatura" style="max-height: 80px; max-width: 100%;">
                    </div>
                @else
