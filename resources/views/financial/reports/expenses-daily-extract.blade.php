...
<div class="row fr-page">
    ...
    <div class="col-12 col-lg-9 fr-main">
        @include('financial.reports.partials.daily-filters', [
            'action' => route('financial.reports.expenses.daily-extract'),
            'categories' => $categoriesDespesas,
        ])

        <div class="card fr-card mb-4">
            <div class="card-body">
                @include('financial.reports.partials.report-head', [
                    'title' => 'Despesas — Extrato diário',
                ...
                <div class="fr-table-toolbar">
                    ...
                    <div class="fr-table-toolbar__actions">
                        <form method="GET" action="{{ route('financial.reports.expenses.daily-extract') }}" id="tableForm" class="fr-table-toolbar__actions">
