...
@section('title', 'Relatório: Despesas - Resumo anual por categoria')
...
@section('breadcrumbs')
    ...
    <li><span>Despesas - Resumo anual por categoria</span></li>
@endsection
...
<div class="row">
    ...
    <div class="col-lg-9">
        ...
        <div class="card mb-4" style="border: none; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <div class="card-body">
                <form method="GET" action="{{ route('financial.reports.expenses.annual-summary') }}" id="filterForm">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h6 class="mb-0">Relatório: Despesas - Resumo anual por categoria</h6>
                ...
                <div class="mb-4">
                    @include('financial.partials.monthly-bars-chart', [
                        ...
                        'seriesName' => 'Despesas por mês',
                        'color' => '#F5A623',
                        'emptyMessage' => 'Sem despesas registradas em ' . $year,
                    ])
                </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="table-secondary">
                                    ...
                                    <td class="text-end"><strong class="text-danger">R$ {{ number_format($totalGeral, 2, ',', '.') }}</strong></td>
