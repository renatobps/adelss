...
<div class="row fr-page">
    ...
    <div class="col-12 col-lg-9 fr-main">
        @include('financial.reports.partials.full-filters', [
            'action' => route('financial.reports.revenues-expenses.by-category'),
                    ...
                    <div class="mb-5">
                        ...
                        <div class="fr-table-toolbar">
                            ...
                            <div class="fr-table-toolbar__actions">
                                <form method="GET" action="{{ route('financial.reports.revenues-expenses.by-category') }}" id="tableFormReceitas" class="fr-table-toolbar__actions">
                ...
                @if($despesas->count() > 0 || !$categoryDespesasId)
                    <div class="mb-5">
                        ...
                        <div class="fr-table-toolbar">
                            ...
                            <div class="fr-table-toolbar__actions">
                                <form method="GET" action="{{ route('financial.reports.revenues-expenses.by-category') }}" id="tableFormDespesas" class="fr-table-toolbar__actions">
